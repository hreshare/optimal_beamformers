...
if [ $# != 8 ]; then
   echo "Wrong #arguments ($#, expected 8)"
   echo "Usage: local/run_train_and_infer.sh [options] <chime4-dir> <chime3-dir> <wav-out-dir> <bg_gain> <mode_from> <mode_to> <powm_itr> <do_plot>"
